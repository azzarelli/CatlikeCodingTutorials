...
public static class FunctionLibrary
{
	...
	public static FunctionName GetNextFunctionName (FunctionName name) {
		// As enumerated functions store the names w.r.t index values, we can look at the length
		// this way we can change the numbebr of functions without having to update this one
